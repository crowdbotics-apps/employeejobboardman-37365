...
## Project Structure
    ...
    ├── employeejobboardman_37365  # Django project configurations
...
1. Clone this repo and `cd employeejobboardman_37365`
...
2. Clone this repo and `cd employeejobboardman_37365`
